...
const OfferTextaria = (props) => {
  return (
    ...
    <section className={styles.name_section}>
        <label id={props.name} className={styles.label_name}>
            <span>{props.label}</span>
        </label>
        <textarea  defaultValue={props.defaultValue} onChange={props.onChange} className={styles.label_name} type="text" name={props.name} ></textarea>
    </section>
